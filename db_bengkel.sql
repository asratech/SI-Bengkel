...
--
-- Host: 127.0.0.1
-- Generation Time: 20 Mar 2018 pada 14.55
...
INSERT INTO `tbl_barang` (`id_barang`, `nama_barang`, `satuan_barang`, `harga_beli_satuan`, `harga_jual_satuan`, `diskon`, `ppn`, `stock_barang`, `id_supplier`, `tanggal_masuk`, `tanggal_input`, `id_user`) VALUES
(1, 'test2', 'pcs', 10, 10, '10', '101', 10, 1, '2017-08-08', '2018-01-23 06:14:13', 2);
...
INSERT INTO `tbl_bonus` (`id_bonus`, `nomor_polisi`, `jumlah_cuci`) VALUES
(1, 'D 9090 ASU', 5),
(2, '78', 1),
(3, 'F 9999 ZZ', 4);
...
INSERT INTO `tbl_costumer` (`id_costumer`, `nama_costumer`, `alamat`, `provinsi`, `kota`, `kode_pos`, `telepon`, `tanggal_daftar`, `id_user`) VALUES
(1, 'TIDAK ADA', '-', '-', '-', 0, '0', '2018-01-22 11:36:03', 1),
(2, 'TEMY', '-', '-', '-', 0, '0', '2018-01-22 12:01:12', 1);
...
--
-- Dumping data untuk tabel `tbl_hutang_supplier`
--

INSERT INTO `tbl_hutang_supplier` (`id_hutang_supplier`, `id_supplier`, `jumlah`, `bayar`, `sisa`, `keterangan`, `tanggal`, `tanggal_input`, `id_user`) VALUES
(1, 1, 100, 0, 100, '', '2018-01-23', '2018-01-23 06:11:51', 2);
...
--
-- Dumping data untuk tabel `tbl_piutang_costumer`
--

INSERT INTO `tbl_piutang_costumer` (`id_piutang_costumer`, `id_costumer`, `nomor_bukti_transaksi`, `jumlah`, `bayar`, `sisa`, `keterangan`, `tanggal`, `tanggal_input`, `id_user`) VALUES
(1, 2, 'TRS-20180122120237', 0, 0, 0, 'BELUM LUNAS', '2018-01-22', '2018-01-22 12:03:29', 2),
(2, 2, 'TRS-20180122120618', 0, 0, 0, 'BELUM LUNAS', '2018-01-22', '2018-01-22 12:06:57', 2),
(3, 2, 'TRS-20180122120618', 0, 0, 0, 'BELUM LUNAS', '2018-01-22', '2018-01-22 12:26:52', 2);
...
--
-- Dumping data untuk tabel `tbl_sub_transaksi_jasa`
--

INSERT INTO `tbl_sub_transaksi_jasa` (`id_sub_transaksi_jasa`, `id_transaksi`, `id_jasa`, `harga_jual`, `diskon`, `ppn`, `sub_total`, `tanggal_input`, `id_user`) VALUES
(1, 1, 4, 0, '0', '0', 0, '2018-01-22 11:37:10', 2),
(2, 2, 3, 0, '0', '0', 0, '2018-01-22 11:53:48', 2),
(3, 3, 4, 0, '0', '0', 0, '2018-01-22 11:54:41', 2),
(4, 5, 3, 0, '0', '0', 0, '2018-01-22 11:58:44', 2),
(5, 6, 2, 0, '0', '0', 0, '2018-01-22 12:03:29', 2),
(6, 6, 3, 0, '0', '0', 0, '2018-01-22 12:03:29', 2),
(7, 7, 2, 0, '0', '0', 0, '2018-01-22 12:06:57', 2),
(8, 7, 3, 0, '0', '0', 0, '2018-01-22 12:06:57', 2),
(9, 9, 1, 0, '0', '0', 0, '2018-01-22 12:14:49', 2);
...
INSERT INTO `tbl_supplier` (`id_supplier`, `nama_supplier`, `alamat`, `provinsi`, `kota`, `kode_pos`, `telepon`, `tanggal_input`, `id_user`) VALUES
(1, 'PP', 'PP', 'P', 'PP', 124, '43', '2018-01-23 06:11:25', 2);
...
INSERT INTO `tbl_transaksi` (`id_transaksi`, `nomor_polisi`, `tipe_kendaraan`, `nomor_bukti_transaksi`, `id_costumer`, `jumlah_bayar`, `bayar`, `kembalian`, `keterangan`, `tanggal_input`, `id_user`) VALUES
(1, 'D 9090 ASU', 'KK', 'TRS-20180122113629', 1, 0, 100, 100, 'LUNAS', '2018-01-22 11:37:10', 2),
(2, '78', 'kj', 'TRS-20180122114222', 1, 0, 0, 0, 'LUNAS', '2018-01-22 11:53:48', 2),
(3, 'asd', '123', 'TRS-20180122115411', 1, 0, 0, 0, 'LUNAS', '2018-01-22 11:54:41', 2),
(4, 'sdf', 'asfdsdf', 'TRS-20180122115510', 1, 0, 0, 0, 'LUNAS', '2018-01-22 11:57:32', 2),
(5, 'D 9090 ASU', 'Avanza', 'TRS-20180122115816', 1, 0, 0, 0, 'LUNAS', '2018-01-22 11:58:44', 2),
(6, 'D 9090 ASU', 'Avanza', 'TRS-20180122120237', 2, 0, 0, 0, 'LUNAS', '2018-01-22 12:03:29', 2),
(7, 'F 9999 ZZ', 'Kijang', 'TRS-20180122120618', 2, 0, 0, 0, 'LUNAS', '2018-01-22 12:06:57', 2),
(8, 'F 9999 ZZ', 'Avanza', 'TRS-20180122121233', 1, 0, 0, 0, 'LUNAS', '2018-01-22 12:12:46', 2),
(9, 'D 9090 ASU', '903', 'TRS-20180122115946', 1, 0, 0, 0, 'LUNAS', '2018-01-22 12:14:49', 2);
...
(1, 'alfigusman', 'a19a03ceeff62f89b591dd1bd2a16e3e', 'Alfi Gusman', '2018-01-24 08:40:50', '2018-01-24 08:56:50', '10.166.162.162'),
(2, 'piscalpratama', 'a19a03ceeff62f89b591dd1bd2a16e3e', 'Piscal Pratama', '2018-01-23 06:47:03', '0000-00-00 00:00:00', '10.166.162.83');
...
--
ALTER TABLE `tbl_bonus`
  MODIFY `id_bonus` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tbl_costumer`
--
ALTER TABLE `tbl_costumer`
  MODIFY `id_costumer` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_hutang_supplier`
--
ALTER TABLE `tbl_hutang_supplier`
  MODIFY `id_hutang_supplier` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbl_piutang_costumer`
  MODIFY `id_piutang_costumer` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `tbl_sub_transaksi_jasa`
  MODIFY `id_sub_transaksi_jasa` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
